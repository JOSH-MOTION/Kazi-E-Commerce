...
// ─── Admin PIN — read from env, never hardcoded ───────────────────────────────
export const ADMIN_MASTER_PIN = process.env.NEXT_PUBLIC_ADMIN_PIN ?? '2025';

// ─── MoMo / WhatsApp config — read from env ───────────────────────────────────
export const MOMO_CONFIG = {
  number:       process.env.NEXT_PUBLIC_STORE_MOMO_NUMBER   ?? '0242403450',
  whatsapp:     process.env.NEXT_PUBLIC_STORE_WHATSAPP      ?? '233242403450',
  name:         process.env.NEXT_PUBLIC_STORE_MOMO_NAME     ?? 'Joshua Doe',
  instructions: 'Please pay the exact amount. Use your full name as the reference in your MoMo app. Works with MTN, Telecel, and AT.',
};

// ─── Paystack — public key only (secret stays server-side) ───────────────────
export const PAYSTACK_PUBLIC_KEY = process.env.NEXT_PUBLIC_PAYSTACK_PUBLIC_KEY ?? '';

// ─── Static seed data (fallback when Firestore is empty) ─────────────────────
