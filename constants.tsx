...
export const PRODUCTS: Product[] = [
  {
    ...
    variants: [
      ...
      { id: 'v-1-l-b', sku: 'WS-BLK-L', size: 'L', colorName: 'Obsidian', hexColor: '#1a1a1a', price: 180, stock: 0, isComingSoon: false },
      { id: 'v-1-s-o', sku: 'WS-OLV-S', size: 'S', colorName: 'Olive Drab', hexColor: '#556b2f', price: 180, stock: 8, isComingSoon: false },
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'v-2-blu', sku: 'BAG-BLU', colorName: 'Indigo', hexColor: '#000080', price: 350, stock: 0, isComingSoon: true }
    ]
  },
  {
    id: 'p-3',
    ...
    variants: [
      { id: 'v-3-gr', sku: 'MSG-GRY', colorName: 'Concrete', hexColor: '#808080', price: 420, stock: 10, isComingSoon: false }
    ]
  }
];
