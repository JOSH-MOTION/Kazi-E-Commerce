    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
      ...
      <div>
        ...
        <ul className="text-[8px] space-y-2.5 font-bold uppercase tracking-widest">
          <li><button onClick={() => navigate('track-order')} className="hover:text-white transition-colors flex items-center gap-1 group">Order Status <ArrowUpRight size={8} className="opacity-0 group-hover:opacity-100 transition-opacity" /></button></li>
          <li><button onClick={() => navigate('support')} className="hover:text-white transition-colors flex items-center gap-1 group">Contact Support <ArrowUpRight size={8} className="opacity-0 group-hover:opacity-100 transition-opacity" /></button></li>
          <li><button onClick={() => navigate('momo-guide')} className="hover:text-white transition-colors flex items-center gap-1 group">MoMo Verification <ArrowUpRight size={8} className="opacity-0 group-hover:opacity-100 transition-opacity" /></button></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="text-[8px] space-y-2.5 font-bold uppercase tracking-widest">
          <li><button onClick={() => navigate('returns')} className="hover:text-white transition-colors">Shipping & Returns</button></li>
          <li><button onClick={() => navigate('returns')} className="hover:text-white transition-colors">Privacy & Security</button></li>
          <li><button onClick={() => navigate('returns')} className="hover:text-white transition-colors">Terms of Service</button></li>
        </ul>
      </div>
